    ...
    update_state: function () {
	    ...
	    if (player && player.curGameRoom) {
		    if (const_val.CLUB_ROOM === player.curGameRoom.room_type) {
			    ...
			    this.applyclose_btn.setVisible(player.curGameRoom.curRound > 0);
			    this.close_btn.setVisible(player.curGameRoom.curRound <= 0 && player.curGameRoom.playerInfoList[player.serverSitNum]["is_creator"] === 1);
			    this.out_btn.setVisible(player.curGameRoom.curRound <= 0 && player.curGameRoom.playerInfoList[player.serverSitNum]["is_creator"] !== 1);
		    }
